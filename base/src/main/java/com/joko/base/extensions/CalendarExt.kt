...
/** Result Sunday, 32 January 2021 **/
fun Date.formatEEEEddMMMMMyyyy(): String? {
    val convert = SimpleDateFormat("EEEE, dd MMMM yyyy", Locale.getDefault())
    return convert.format(this)
}
...
/** Result 32 January 2021 **/
fun Date.formatddMMMMyyyy(): String? {
    val convert = SimpleDateFormat("dd MMMM yyyy", Locale.getDefault())
    return convert.format(this)
}
